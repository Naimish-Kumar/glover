...
import 'package:glover/views/pages/booking/booking.page.dart';
import 'package:glover/views/pages/commerce/commerce.page.dart';
import 'package:glover/views/pages/food/food.page.dart';
import 'package:glover/views/pages/grocery/grocery.page.dart';
import 'package:glover/views/pages/parcel/parcel.page.dart';
import 'package:glover/views/pages/pharmacy/pharmacy.page.dart';
import 'package:glover/views/pages/product/amazon_styled_commerce_product_details.page.dart';
import 'package:glover/views/pages/product/product_details.page.dart';
import 'package:glover/views/pages/search/product_search.page.dart';
import 'package:glover/views/pages/search/search.page.dart';
import 'package:glover/views/pages/search/service_search.page.dart';
import 'package:glover/views/pages/service/service.page.dart';
import 'package:glover/views/pages/taxi/taxi.page.dart';
import 'package:glover/views/pages/vendor/vendor.page.dart';
