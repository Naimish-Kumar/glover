...
import 'package:glover/views/pages/auth/forgot_password.page.dart';
import 'package:glover/views/pages/auth/login.page.dart';
import 'package:glover/views/pages/auth/register.page.dart';
import 'package:glover/views/pages/checkout/checkout.page.dart';
import 'package:glover/views/pages/delivery_address/delivery_addresses.page.dart';
import 'package:glover/views/pages/delivery_address/edit_delivery_addresses.page.dart';
import 'package:glover/views/pages/delivery_address/new_delivery_addresses.page.dart';
import 'package:glover/views/pages/favourite/favourites.page.dart';
import 'package:glover/views/pages/home.page.dart';
import 'package:glover/views/pages/order/orders_tracking.page.dart';
import 'package:glover/views/pages/profile/change_password.page.dart';
import 'package:glover/views/pages/vendor_details/vendor_details.page.dart';
import 'package:glover/views/pages/notification/notification_details.page.dart';
import 'package:glover/views/pages/notification/notifications.page.dart';
import 'package:glover/views/pages/onboarding.page.dart';
import 'package:glover/views/pages/order/orders_details.page.dart';
import 'package:glover/views/pages/product/product_details.page.dart';
import 'package:glover/views/pages/profile/edit_profile.page.dart';
import 'package:glover/views/pages/search/search.page.dart';
import 'package:glover/views/pages/wallet/wallet.page.dart';
import 'package:glover/views/shared/location_fetch.page.dart';
